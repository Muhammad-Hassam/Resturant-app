...
const food= data.filter(data => data.type === "Dinner");
    ...
    return (
        ...
        <View style={styles.main}>
          <Text style={theme===false?styles.breakfast:styles.breakfasttheme}>Dinner</Text>
           {food.map((item,index)=>{
               return(
                <Card 
                key={index}
                containerStyle={{ paddingTop:20,elevation:10,marginTop:30,paddingBottom:20, paddingLeft: 10, paddingRight:10,borderRadius:15}} >
